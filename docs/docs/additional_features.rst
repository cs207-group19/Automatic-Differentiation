...
- :math:`f_1(x) = \dfrac{-1}{0.5^2} x^2 + 1, x \in [-0.5, 0]`

- :math:`f_2(x) = \dfrac{1}{0.5^2} x^2 - 1, x \in [-0.5, 0]`

- :math:`f_3(x) = \dfrac{-1}{0.5} x^2 + 1, x \in [0, 0.5]`

- :math:`f_4(x) = \dfrac{1}{0.5} x^2 - 1, x \in [0, 0.5]`

- :math:`f_6(x) = \dfrac{-1}{0.5} (x-1.5)^2 + 1, x \in [1, 1.5]`

- :math:`f_7(x) = \dfrac{1}{0.5} (x-1.5)^2 - 1, x \in [1, 1.5]`

- :math:`f_8(x) = \dfrac{-1}{0.5} (x-1.5)^2, x \in [1.5, 2]`

- :math:`f_9(x) = \dfrac{-1}{0.5} (x-1.5)^2 + 1, x \in [1.5, 2]`

- :math:`f_{10}(x) = \dfrac{1}{0.5} (x-1.5)^2 - 1, x \in [1.5, 2]`

- :math:`f_{11}(x) = \dfrac{-1}{0.5} (x-3)^2 + 1, x \in [2.5, 3]`

- :math:`f_{12}(x) = \dfrac{-1}{0.5} (x-3)^2 + 1, x \in [3, 3.5]`

- :math:`f_{13}(x) = 1.5x - 4.75, x \in [2.5, 3.5]`

- :math:`f_{14}(x) = -1, x \in [2.5, 3.5]`

- :math:`f_{15}(x) = \dfrac{-1}{0.5^2} (x-4.5)^2 + 1, x \in [4, 4,5]`

- :math:`f_{16}(x) = \dfrac{1}{0.5^2} (x-4.5)^2 - 1, x \in [4, 4,5]`

- :math:`f_{17}(x) = \dfrac{-1}{0.5^2} (x-4.5)^2 + 1, x \in [4, 4,5]`

- :math:`f_{18}(x) = \dfrac{1}{0.5^2} (x-4.5)^2 - 1, x \in [4.5, 5]`
